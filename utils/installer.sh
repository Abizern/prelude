...
#   Defaults to 'git@github.com:Abizern/prelude.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'git@github.com:Abizern/prelude.git'.\n"
...
[ -z "$PRELUDE_URL" ] && PRELUDE_URL="git@github.com:Abizern/prelude.git"
